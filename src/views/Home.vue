<template>
    <div class="container">
        <div class="recommends">
            ...
            <div v-else>
                <div v-if="this.remainingNumber <= 0">
                    <p class="subtitle"> Calculating recommends...please wait 3-5 seconds </p>
                </div>
                <div v-else>
                    <p class="subtitle"> There is not enough data, to recommend recipes. You have to wait <strong style="color: red"> {{ this.remainingNumber }} </strong> days to get recommendation. </p>
                </div>
            </div>
            </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            remainingNumber(){
                return this.$store.getters.remainingNumber;
            }
        },
        methods: {
        ...
        mounted() {
            ...
            this.$store.dispatch("getRemainingNumber")
